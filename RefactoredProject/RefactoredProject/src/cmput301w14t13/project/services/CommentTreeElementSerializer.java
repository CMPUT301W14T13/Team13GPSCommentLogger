 ...
 * @param <T>
 */
public class CommentTreeElementSerializer implements
    ...
    public synchronized CommentTreeElement deserialize(JsonElement jsonElement, Type type,
        ...
        try {
        	Gson gson = new GsonBuilder().registerTypeAdapter(CommentTreeElement.class, this).setDateFormat("yyyy-MM-dd HH:mm:ss.SSS").registerTypeAdapter(Bitmap.class, new BitmapSerializer()).create();
